    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ModeratedChatsId = table.Column<long>(type: "bigint", nullable: false),
                    ModeratorsId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatUser1", x => new { x.ModeratedChatsId, x.ModeratorsId });
                    table.ForeignKey(
                        name: "FK_ChatUser1_Chats_ModeratedChatsId",
                        column: x => x.ModeratedChatsId,
                        principalTable: "Chats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatUser1_Users_ModeratorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaMessage", x => new { x.MediaId, x.MessagesId });
                    table.ForeignKey(
                        name: "FK_MediaMessage_Medias_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Medias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MediaMessage_Messages_MessagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatUser1_ModeratorsId",
                table: "ChatUser1",
                column: "ModeratorsId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaMessage_MessagesId",
                table: "MediaMessage",
                column: "MessagesId");
